...
import com.finixio.pages.originationPortal.*;
import com.finixio.pages.providerPortal.*;
...
import static com.finixio.driver.DriverManager.waitForPageToLoad;
 ...
 */
public class CustomerFullExprience extends BaseWeb {
        ...
        public void customersuccessTest() throws Exception {
                CustomerLoginPage customerLoginPage = new CustomerLoginPage();
                com.finixio.pages.customerPortal.TopMenu topMenu = new TopMenu();
                startcustomerportal();
