package com.finixio.test.webservices.FinanceOffers;
...
import com.finixio.webservices.FinanceOffers.GetOffersRequest;
import com.finixio.webservices.FinanceOffers.GetSingleOfferRequest;
import com.finixio.webservices.FinanceOffers.SetOfferRequest;
...
public class ActivateAccountWithOffersAdded extends BaseApi {
        ...
        public void gettingallOffersAttachedToAnApplicant() throws Exception {
                ...
                // setoffersData.put("FinanceAmount",
                // offerListings.get("defaultFinanceAmount"));
                // setoffersData.put("DownPaymentAmount",
                // offerListings.get("defaultDownPaymentAmount"));
                // setoffersData.put("TermMonths", offerListings.get("termMonths"));
                // setoffersData.put("InterestRate", offerListings.get("interestRate"));
                ...
                sa = assertionUtil.assertEquals("Finance Ammount", accountData.get("financeTerms.financeAmount"),
                                setoffersData.get("FinanceAmount"), "The Finance Amount : ");

                sa = assertionUtil.assertEquals("Interest Rate",
                                accountData.get("financeTerms.interestRate").toString(),
                                setoffersData.get("InterestRate").toString(), "The Interest Rate : ");

                sa = assertionUtil.assertEquals("Term Months", accountData.get("financeTerms.termMonths"),
                                setoffersData.get("TermMonths"), "The Term Months : ");

                sa = assertionUtil.assertEquals("The DownPaymentAmount",
                                accountData.get("financeTerms.downPaymentAmount"),
                                setoffersData.get("DownPaymentAmount"), "The DownPaymentAmount : ");
        ...
        public void activatingAccount() throws Exception {
                ...
                testcases.put("TestSuiteID", "503");
                testcases.put("TestCaseID", "633");
                generaltestcases.put("TestSuiteID", "503");
                generaltestcases.put("TestCaseID", "639");
        ...
        @Description("Getting all offers that are set to an application ")
        @Test(priority = 12, groups = { "v3" }, description = "Getting all offers that are set to an application ")
        @Story("HFD-39785 : Getting all offers that are set to an application ")
        public void getOfferAddedToTheAccount() throws Exception {
                AssertionUtil assertionUtil = new AssertionUtil();
                SoftAssert sa;
                String service;
                Object json;
                ...
                AllureLifecycle lifecycle = Allure.getLifecycle();
                lifecycle.updateTestCase(testResult -> testResult.setName("Getting The  Offer added to the Account  "
                                + AppilicationID + " After Activation"));
