...
public class ChangeOfferAndChangeFinanceTerms extends BaseApi {
        ...
        Map<String, Object> alternativeOffer = new HashMap<>();
        ArrayList<List<String>> listOfOffers = new ArrayList<List<String>>();
        ...
        public void gettingAllOffersforAvailableFortheApplicant() throws Exception {
                ...
                while (iterator.hasNext()) {
                        ...
                        // listOfOffers.add((List<String>) offerListings);
                ...
                // for (Object innerlist : listdata) {

                // try {
                // System.out.println("Allllllll----------------" + innerlist);
                // } catch (Exception e) {
                ...
                // listOfOffers.add((List<String>) offerListings);
                // System.out.println(
                // "The Final List of Offers is ------------------" + dataList.get(index));
